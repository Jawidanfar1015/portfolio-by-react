...
// import projecOne from "https://pdubya1632.github.io/Get-Outside/"
const Projects = () => {
    return (  
            ...
            <div className="row">
                <div className="card col-sm-11 col-md-5">
                    ...
                    <div className="card-body col-sm-12">
                        <h3>Info</h3>
                        <p>
                            This is a character creator application for D{"&"}D Game,
                            Dangen and Dragon is a very famous game thesee days, Millions of people are playing this game with each other, With this Application, the player can create a Character in 5 mins maximun but without this App! a player to create a Character, it takes between 20 mins up to 2 hours,
                            depending to the player scale and experience.
                ...
                <div className="card col-sm-11 col-md-5">
                    ...
                    <div className="card-body col-sm-12">
                        <h3>Info</h3>
                        <p>
                            This is a simple application for searching the top rated Hiking Places near the User,
                            We used Google Api and OpenWeatherMap Api for this application.
                            The application was deployed but not running at the moment for security reasons.
                            We built this application from scratch and our focus was on creating UI by using a CSS Framework,
                            using a new API. 
                        </p>
                ...
                <div className="card col-sm-11 col-md-5">
                    ...
                    <div className="card-body col-sm-12">
                        <h3>Info</h3>
                        <p>
                            This is a Note Taker application, User can create new notes, can look at the previous notes and the time which was created,
                            User can Edit the notes or delete them.
                ...
                <div className="card col-sm-11 col-md-5">
                    ...
                    <div className="card-body col-sm-12">
                        <h3>Info</h3>
                        <p>
                            This is a Weather app, I used OpenWeatherMap Api for this application.
